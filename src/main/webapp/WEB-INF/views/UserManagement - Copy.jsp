...
<html>
  <head>  
    ...
    <title>Glitterbug Appetite | Admin Dashboard | Orders Table</title>
  ...
  <link href="assets/css/style.css" rel="stylesheet" />
	...
	function showTables()
	{
		document.getElementById('all_tables').style.display='block';
...
<!-- 	<div id="all_tables"> -- >
                  ...
                  <form ng-submit="ctrl.submit()" name="myForm" class="form-horizontal">
                      ...
                      <div class="row">
                          <div class="form-group col-md-12">
                              ...
                              <div class="col-md-7">
                                  <input type="text" ng-model="ctrl.customer.name" name="name" class="customername form-control input-sm" placeholder="Enter your name" required ng-minlength="3"/>
                      ...
                      <div class="row">
                          <div class="form-group col-md-12">
                              ...
                              <div class="col-md-7">
                                  <input type="text" ng-model="ctrl.customer.phone" class="form-control input-sm" placeholder="Enter your Phone number. [This field is validation free]"/>
                              </div>
                          </div>
                      </div>
                      ...
                      <div class="row">
                          <div class="form-group col-md-12">
                              ...
                              <div class="col-md-7">
                                  <input type="email" ng-model="ctrl.customer.emailAddress" name="emailAddress" class="email form-control input-sm" placeholder="Enter your Email" required/>
                                  <div class="has-error" ng-show="myForm.$dirty">
		 ...
		 <!--
          <div class="panel panel-default">
              <div class="panel-heading"><span class="lead">OrderItemPrinted Addition  </span></div>
              <div class="formcontainer">
                  <form ng-submit="ctrl.submit()" name="myForm" class="form-horizontal">
                      <input type="hidden" ng-model="ctrl.orderItemPrinted.id" />
                      <div class="row">
                          <div class="form-group col-md-12">
                              <label class="col-md-2 control-lable" for="file">Order Id</label>
                              <div class="col-md-7">
                                  <input type="text" ng-model="ctrl.orderItemPrinted.orderId" name="orderId" class="orderItemPrintedname form-control input-sm" placeholder="Enter your orderId" required ng-minlength="3"/>
                                  <div class="has-error" ng-show="myForm.$dirty">
                                      <span ng-show="myForm.orderId.$error.required">This is a required field</span>
                                      <span ng-show="myForm.orderId.$error.minlength">Minimum length required is 3</span>
                      ...
                      <div class="row">
                          <div class="form-group col-md-12">
                              <label class="col-md-2 control-lable" for="file">name</label>
                              <div class="col-md-7">
                                  <input type="text" ng-model="ctrl.orderItemPrinted.name" class="form-control input-sm" placeholder="Enter the name. [This field is validation free]"/>
                              </div>
                          </div>
                      </div>
   ...
   <div class="generic-container" ng-controller="OrderController as ctrl">
                  ...
                  <form ng-submit="ctrl.submit()" name="myForm" class="form-horizontal">
                      ...
                      <div class="row">
                          <div class="form-group col-md-12">
                              ...
                              <div class="col-md-7">
                                  <input type="text" ng-model="ctrl.order.customerId" name="customerId" class="ordername form-control input-sm" placeholder="Enter your customer Id" required ng-minlength="3"/>
                                  <div class="has-error" ng-show="myForm.$dirty">
                      ...
                      <div class="row">
                          <div class="form-group col-md-12">
                              ...
                              <div class="col-md-7">
                                  <input type="text" ng-model="ctrl.order.dateOrdered" class="form-control input-sm" placeholder="Enter the Date. [This field is validation free]"/>
                              </div>
                          </div>
                      </div>
    ...
    <script src="assets/scripts/dashboard-demo.js"></script>
      ...
      <script src="<c:url value='/static/js/service/order_id_printed_service.js' />"></script>
      <script src="<c:url value='/static/js/controller/order_id_printed_controller.js' />"></script>
